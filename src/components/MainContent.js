  ...
  return (
    <div className="p-4 w-full">
      ...
      {selectedItem === 'Medi Card' && (
        <>
          <a href='/PrintCard' >
            <div className='flex justify-center md:mt-12' style={{ fontFamily: 'Fredoka One' }}>
                  ...
                  <div className="flip-card-front ">
                    <div className='text-white  rounded-t-xl' style={{ backgroundColor: 'rgb(185 182 221)' }}>
                      <div className="flex mb-4">
                        <div className="w-1/4 ">
                          <img src='./assets/nationalLogo-removebg-preview.png' className='md:h-24 pt-6 md:ms-4 ' />
                        </div>
