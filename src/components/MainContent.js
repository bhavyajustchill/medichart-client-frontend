              ...
              <div className="flip-card-inner">
                <div className="flip-card-front ">
                  ...
                  <div className="flex mb-4 p-5 ">
                    <div className="w-1/3">
                      <img
                        className="h-32 mt-8 rounded-md cursor-pointer"
                        src="/assets/rfid chip.jpg"
                        alt="profile"
                  ...
                  >
                    ...
                    <div className="ms-5">
                      <div>
                        ...
                        <p className="text-xs">
                          આ MEDI વડે તમે ભારતના ડિજિટલ હેલ્થ ઇકોસિસ્ટમનો એક ભાગ
                          બની ગયા છો
                        </p>
                      </div>
                      ...
                      <div className="mt-3">
                        <p className="text-md">
                          You Can download the MEDI mobile app, Aarogya Setu or
                          Other MCHA enabled app to view and share digital
                          health records with MCHA registered healthcare service
                          providers
                        </p>
                        <p className="text-xs">
