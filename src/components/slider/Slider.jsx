                    ...
                    <div
                        ...
                        <div className="flex flex-wrap  w-full">
                            ...
                            <div className="w-full lg:w-1/2 pr-4 pl-4 flex flex-col p-6 md:p-12 order-1 text-start lh-base" style={{ lineHeight: "86.4px", fontWeight: "500", }}>
                                ...
                                <div className="w-full gap-2 mt-10 flex md:justify-center lg:justify-start flex-col md:flex-row gap-md-3 text-center">
                                ...
                                <div className="flex flex-row gap-4 mt-4 lg:mt-12">
