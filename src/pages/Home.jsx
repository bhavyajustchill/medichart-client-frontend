  ...
  return (
    <>
                ...
                <div className="md:w-1/2">
                  ...
                  <div className="flex md:flex-row flex-col md:mt-10 mt-5">
                    <div className="md:w-1/2 flex md:ms-0 ms-44 ">
                      ...
                      >
                        <path
                          d="M18.75 21.623H5.25a.75.75 0 01-.75-.75v-16.5a.75.75 0 01.75-.75h9l5.25 5.25v12a.75.75 0 01-.75.75z"
                          stroke="currentColor"
                          stroke-width="1.5"
                        ...
                        ></path>
                        <path
                          d="M14.25 3.623v5.25h5.25M9.375 15.248L12 17.873l2.625-2.625M12 11.873v6"
                          stroke="currentColor"
                          stroke-width="1.5"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                    ...
                    <div className="md:w-1/2 flex md:ms-0 ms-32">
                      ...
                      >
                        <path
                          d="M20.25 5.123H3.75a.75.75 0 00-.75.75v13.5c0 .414.336.75.75.75h16.5a.75.75 0 00.75-.75v-13.5a.75.75 0 00-.75-.75z"
                          stroke="currentColor"
                          stroke-width="1.5"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        ></path>
                        <path
                          d="M5.737 13.362a.75.75 0 000 1.5v-1.5zm10.5 1.5a.75.75 0 100-1.5v1.5zm-10.5 0h10.5v-1.5h-10.5v1.5zM5.737 16.362a.75.75 0 000 1.5v-1.5zm6 1.5a.75.75 0 100-1.5v1.5zm-6 0h6v-1.5h-6v1.5z"
                          fill="currentColor"
                        ></path>
                        <circle
                          cx="7.133"
      ...
      <div>
        ...
        <p className="md:mt-6 mt-2 ms-auto text-center md:text-md text-sm ">
          Store, search and organise all medical records as per your convenience
        </p>
        ...
        <div className="flex md:flex-row flex-col mb-4 mt-8 container mx-auto">
          <div className="md:w-1/2 ">
            <div
              className="flex mt-5"
              onClick={() =>
                changeImage("/assets/cl5i49ojv000l0sh9gxwr32fp.png")
              }
            >
              <img
                src="/assets/cl5c2clg0001p0tchfaerew42.png"
                className="ms-12 md:w-14 md:h-14 h-10"
                alt="Store"
              />
            ...
            <div
              className="flex mt-7"
              onClick={() =>
                changeImage("/assets/cl5i4b39n000x0shh4cldhaqn.png")
              }
            >
              <img
                src="/assets/cl5c2dcnm001r0tchau7r8632.png"
                className="ms-12 md:w-14 md:h-14 h-10"
                alt="Search"
              />
              <p className="ms-4 md:text-lg text-sm font-medium">Search</p>
              <div>
                <p className="mt-8 md:text-md text-sm md:-ms-14 -ms-10">
                  {" "}
                  Search records using vitals name, diseases & more
                </p>
                <button className="btn btn-outline btn-primary md:mt-8 mt-3 w-24 md:-ms-14 -ms-12">
                  Try Now
                </button>
              </div>
            </div>
            ...
            <div
              className="flex mt-7"
              onClick={() =>
                changeImage("/assets/cl5i4bgdo000n0sh9hl9365uk.png")
              }
            >
              <img
                src="/assets/cl5c2efv5001t0tch0sbxczup.png"
                className="ms-12 md:w-14 md:h-14 h-10"
                alt="Organise"
              />
              <p className="ms-4 md:text-lg text-sm font-medium">Organise</p>
              <div>
                <p className="mt-8 md:text-md text-sm md:-ms-16 -ms-14">
                  {" "}
                  Search records using vitals name, diseases & more
                </p>
                <button className="btn btn-outline btn-primary md:mt-8 mt-3 w-24 md:-ms-20 -ms-16">
                  Try Now
                </button>
              </div>
            </div>
      ...
      <div className="flex md:flex-row flex-col container mx-auto mt-14">
        <div className="md:w-1/3 flex  md:justify-start justify-center items-center">
          <div className="card w-96 bg-base-100 shadow-2xl">
            <div className="card-body">
              <img
                src="/assets/cl5b7jnw1000v0tch72qp8d22.png"
                className="h-10 w-10"
              />
        ...
        <div className="md:w-1/3 flex md:flex-row flex-col md:justify-center justify-center items-center ">
          <div className="card w-96 bg-base-100 shadow-2xl md:mt-0 mt-8">
            <div className="card-body">
              <img
                src="/assets/cl5b7lgtb000z0tch8nt5d9uw.png"
                className="h-10 w-10"
              />
        ...
        <div className="md:w-1/3 flex md:flex-row flex-col md:justify-end justify-center md:items-end items-center">
          <div className="card w-96 bg-base-100 shadow-2xl  md:mt-0 mt-8">
            <div className="card-body">
              <img
                src="/assets/cl5b7mvg3000n0sff2r2i3t9f.png"
                className="h-6 w-10"
              />
              <p className="text-2xl mt-2  font-bold">Upload a picture</p>
              <p className="text-sm mt-3">
                Click or upload a photo and we will scan those records
              </p>
      ...
      <div className="flex md:flex-row flex-col container mx-auto p-10"></div>
          ...
          <div className="card lg:card-side bg-[#AAF1FF] shadow-xl container mx-auto ">
            <div className="card-body">
              <div className="flex md:flex-row flex-col">
                ...
                <div className="md:w-1/2">
                  <img
                    className="h-auto md:max-w-64 md:ms-64 mt-5"
                    src="/assets/cl5jnr1nn00110shacznxb25v.png"
                  />
                </div>
              </div>
      ...
      <p className="md:mt-6 mt-2 font-bold md:text-4xl text-lg ms-auto text-center">
        An automated health profile from your medical data
      </p>
      <p className="md:mt-6 mt-2 ms-auto text-center md:text-md text-sm ">
        See longitudinal vital trends, get health insights, and stay one step
        ahead
      </p>
        ...
        <div className="card-body">
          <div className="flex md:flex-row flex-col">
            <div className="md:w-1/2 p-4">
              <p className="md:text-5xl text-xl font-bold md:text-start text-center text-white">
                Are you a doctor?
              </p>
              ...
              <button className="bg-[#17185A] rounded-lg text-white w-52 h-12 md:mt-9 mt-5  md:ms-0 ms-36">
                CONTACT US
              </button>
            </div>
