...
export default function Home() {
  return (
    <>
            ...
            <div className="card-body">
              <div className="flex md:flex-row flex-col">
                <div className="md:w-1/2">
                  ...
                  <button className="btn btn-primary md:mt-7 mt-5 md:ms-0 ms-28">CREATE ABHA</button>
      ...
      <div className="flex md:flex-row flex-col mb-4 mt-8">
        <div className="md:w-1/2 ">
        ...
        <div className="w-1/2">
          <img src="/assets/image12.jpg" className="md:h-auto h-64 max-w-xs md:ms-64 ms-32" />
        </div>
      </div>
      <div className="flex md:flex-row flex-col container mx-auto p-10">
        ...
        <div className="card w-96 bg-base-100 shadow-2xl md:ms-14 md:mt-0 mt-8">
        <div className="card-body">
        ...
        <div className="card w-96 bg-base-100 shadow-2xl md:ms-14 md:mt-0 mt-8">
        <div className="card-body">
           <img src="/assets/cl5b7mvg3000n0sff2r2i3t9f.png" className="h-10 w-10"/>
            ...
            <div className="card-body">
              <div className="flex md:flex-row flex-col">
                <div className="md:w-1/2">
                  ...
                  <button className="bg-[#104751] rounded-lg text-white w-52 h-12 md:mt-7 mt-5 md:ms-0 ms-16">DOWNLOAD CERTIFICATE</button>
                  <div className="flex md:flex-row flex-col mt-7">
                    <div className="md:w-1/2 ">
