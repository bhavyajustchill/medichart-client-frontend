      ...
      <div className="flex items-center justify-center " style={{
        ...
        <div className="card lg:card-side bg-base-100 shadow-2xl w-1/2  " >
          <div className="card-body ">
            ...
            <input type="text" placeholder="Enter Name" className="input w-full border border-blue-400 h-8 mt-5" />
            <input type="text" placeholder="Enter Mobile No." className="input w-full border border-blue-400 h-8 mt-2" />
            <input type="text" placeholder="Enter Email" className="input mt-2 w-full border border-blue-400 h-8" />
            <input type="text" placeholder="Enter Adharcard No." className="input mt-2 w-full border border-blue-400 h-8" />
