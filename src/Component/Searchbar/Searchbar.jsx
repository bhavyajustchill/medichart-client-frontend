...
const Searchbar = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className="position-absolute h-100 w-100 overflow-hidden z-0 "
        ...
        >
          ...
          <div
            className="medichart"
            style={{ background: "#00000022", backdropFilter: "blur(3px)" }}
          ></div>
        </div>
        <div className="z-3 position-relative">
          ...
          ></div>
          <div
            className="fw-bold text-start text-md-center text-white pt-2 px-3"
            style={{ fontSize: "50px" }}
          >
            Your home for health
          </div>
          <div className="fs-2 text-start text-md-center  text-white px-3">
            Find and Book
          </div>
