        ...
        <div className="col-12 col-md-6">
          ...
          >
            <div className="w-100 display-6 fw-semibold">
              Download the medichart App
            </div>
            <div className="w-100 mt-3">
              <p>
                Access video consultation with India's top doctors on the
                medichart app. Connect with doctors online, available 24/7, from
                the comfort of your home.
              </p>
            </div>
            <h6 className="w-100 mt-2 mt-md-5">
            ...
            <div className="w-100 row">
              ...
              <div className="col-12 col-sm-4 p-1">
                <button
                  type="button"
                  className="w-100 h-100 btn btn-info fw-semibold text-white"
                >
                  Send SMS
                </button>
              </div>
